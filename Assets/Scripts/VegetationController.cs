...
//     // ---------- NEW: Tree Height Feature (Y-only) ----------
...
//     [HideInInspector] public float treeHeightScale = 1.0f; // hook your UI slider here
...
//     // ---------- NEW: Per-tree anchors & baselines for Y scaling ----------
//     class TreeAnchor
//     {
//         public Transform t;
//         public Vector3 baseLocalPos;     // position before Y-only scaling
//         public Vector3 baseLocalScale;   // scale before Y-only scaling (includes uniformScale randomization)
...
//         // Capture per-tree anchors after initial scales/actives are set
...
//             // Keep the base pinned: deltaY = (1 - h) * baseBottomLocalY
...
//                 go.transform.localScale = Vector3.one * s;
//             }
//             // our Y-only height sits on top of this, so refresh anchors
//             CaptureAnchorsFromPool();
//             return;
//         }
...
public class VegetationController : MonoBehaviour
{
    ...
    void BuildPoolAndCandidates()
    {
        ...
        if (need > 0)
        {
            ...
            {
                var pos = candidates[i];
                var prefab = PickPrefab(); // <--- NEW: type-aware selection
    ...
    // ---------- NEW: choose a prefab based on current type settings ----------
    ...
    // ======================================================================
    // NEW: public APIs for UI to change tree type
    // ======================================================================
